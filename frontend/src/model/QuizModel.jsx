class QuizModel {
  async createQuiz(quiz, UserId) {
    try {
      const response = await fetch(`https://service-quizyb.onrender.com/quiz/${UserId}`, {
  ...
  async getQuizzes(UserId) {
    try {
      const response = await fetch(`https://service-quizyb.onrender.com/result/${UserId}/quizzes`, {
  ...
  async getQuiz (quizId) {
    try {
      const response = await fetch(`https://service-quizyb.onrender.com/answer/${quizId}`, {
        method: "GET", // *GET, POST, PUT, DELETE, etc.
        mode: "cors", // no-cors, *cors, same-origin
        // cache: "no-cache", // *default, no-cache, reload, force-cache, only-if-cached
        // credentials: "same-origin", // include, *same-origin, omit
  ...
  async getResultByQuiz(quizId) {
    try {
      const response = await fetch(`https://service-quizyb.onrender.com/result/${quizId}/players`, {
        method: "GET", // *GET, POST, PUT, DELETE, etc.
        mode: "cors", // no-cors, *cors, same-origin
        cache: "no-cache", // *default, no-cache, reload, force-cache, only-if-cached
        credentials: "same-origin", // include, *same-origin, omit
